...
RoutineNList={'fatigue_tiptoe_stand','fatigue_tiptoe_sit' };
...
[feat_rmg1,pk_rmg1,featMean_rmg1,h_rmg(1)] = brEstAvg(Ch_data_filt(:,RMG_ch_featDet1),fsDS,opts3,Chan_Name(RMG_ch_featDet1),Motion);
[feat_rmg2,pk_rmg2,featMean_rmg2,h_rmg(2)] = brEstAvg(Ch_data_filt(:,RMG_ch_featDet2),fsDS,opts3,Chan_Name(RMG_ch_featDet2),Motion);
%[feat_emgOpt,pk_emgOpt,featMean_emgOpt,h_emgOpt] = brEstAvg(Ch_data_filt(:,EMG_ch_opt),fsDS,opts3,Chan_Name(EMG_ch_opt),Motion);

feat_emgOpt=[];pk_emgOpt=[];h_emgOpt=[];
